...
<MermaidDiagram code={`C4Component
  ...
  Rel(clicksign, agents, "webhook: signature_completed")`} caption="Diagrama C4 Nível 3 — integrações externas dos agentes e workflows" />
