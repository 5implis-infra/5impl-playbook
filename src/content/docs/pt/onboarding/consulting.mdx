...
description: "Sequência de onboarding pós-assinatura de contrato de consultoria."
---
...
<MermaidDiagram code={`sequenceDiagram
  ...
  S->>WP: provisioning_approved`} caption="Fase 1 — fluxo pós-assinatura de contrato até aprovação de provisionamento" />
...
<MermaidDiagram code={`sequenceDiagram
  ...
  IO->>Client: envia invoice do milestone (Hermes)`} caption="Fase 2 — fluxo pós-provisionamento: kickoff, desenvolvimento e faturamento por milestone" />
