---
title: "Provisioning de Workspace"
description: "Setup completo de novo workspace de cliente — checklist e automações de provisionamento."
---
...
<MermaidDiagram code={`flowchart TD
  ...
  L --> M[workspace_provisioned]`} caption="Fluxo completo de provisionamento de workspace de cliente" />
