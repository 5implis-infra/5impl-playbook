...
description: "Script TypeScript de provisionamento automático de todas as coleções Directus."
---

# Script Bootstrap

Script TypeScript de provisionamento automático de todas as coleções Directus da 5impl.is.

**Execução:** `npx ts-node bootstrap.ts`

**Variáveis de ambiente necessárias:**
- `DIRECTUS_URL` — URL da instância Directus (padrão: `http://localhost:8055`)
- `DIRECTUS_ADMIN_TOKEN` — Token de administrador do Directus
