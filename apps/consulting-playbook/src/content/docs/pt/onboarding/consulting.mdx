...
```mermaid
sequenceDiagram
  title Fase 1 — fluxo pós-assinatura de contrato até aprovação de provisionamento
...
```mermaid
sequenceDiagram
  title Fase 2 — fluxo pós-provisionamento: kickoff, desenvolvimento e faturamento por milestone
