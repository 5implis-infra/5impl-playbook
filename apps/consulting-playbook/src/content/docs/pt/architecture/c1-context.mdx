...
description: C4 Model Nível 1 — visão macro do ecossistema 5impl.is, atores, sistemas externos e fronteiras.
---
...
<MermaidDiagram code={`C4Context
  ...
  Rel(fiveimpl, gsearch, "Coleta métricas SEO semanalmente via ContentAnalyst")`} caption="Diagrama C4 Nível 1 — Contexto completo" />
