---
title: "Schemas e Dados"
description: "Todas as coleções Directus com campos, tipos, relações e diagrama ER completo."
---
...
<MermaidDiagram code={`erDiagram
  ...
  Church_Clients ||--o{ Interactions : "has"`} caption="Diagrama ER completo das coleções Directus" />
